...
export const MOCK_ACTIVITY_LOGS: ActivityLog[] = [
  ...
  {
    id: 'log-9',
    action: 'host.account.registered',
    occurredAt: '2026-05-20T10:00:00.000Z',
    actorId: 'host-3',
    actorEmail: 'newhost@example.com',
    actorName: 'New Organizer',
    actorRole: 'host',
    targetType: 'user',
    targetId: 'host-3',
    message: 'from=; to=pending',
  },
  {
    id: 'log-10',
    action: 'admin.host.approved',
    ...
    targetType: 'user',
    targetId: 'host-1',
    message: 'from=pending; to=active; reason=Business documents verified',
  },
]
